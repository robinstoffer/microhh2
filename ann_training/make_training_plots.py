...
if __name__ == '__main__':
    #os.chdir('/projects/1/flowsim/gmd_results_training_final/train_8dx4dz_test_all')#Set working directory
    #os.chdir('/projects/1/flowsim/gmd_results_training_final/train_4dx4dz_12dx4dz_test_all')#Set working directory
    os.chdir('/projects/1/flowsim/gmd_results_training_final/train_all_test_all')#Set working directory
    log_files_training = [];
