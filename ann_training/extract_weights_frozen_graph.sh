...
python3 freeze_graph.py --input_graph ./MLP${MLPNUM}/optimized_inference_graph.pb --input_checkpoint ./MLP${MLPNUM}/model.ckpt-500000 --output_graph ./MLP${MLPNUM}/frozen_inference_graph.pb --output_node_names output_layer_denorm
