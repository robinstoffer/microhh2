...
##Define wrapper function for multiprocessing
#def call_generate_training_data(coarse_res, output_directory, training_filepath, means_stdev_filepath):
#    generate_training_data(coarse_res, input_directory, output_directory, size_samples = 5, testing = False, periodic_bc = (False,True,True), zero_w_topbottom = True, settings_filepath = settings_filepath, grid_filepath = grid_filepath, name_output_file = name_training_file)
#
#Generate training data
output_directory = '/projects/1/flowsim/training_data_gmd/8dx4dz'
